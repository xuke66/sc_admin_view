...
export const useSettingStore = defineStore(
	...
	() => {
		...
		const primaryColor = computed({
			get: () => {
				const defaultMode = theme.globalThemeMode === GlobalThemeEnum.System ? (isDark.value ? theme.defaultDarkMode : GlobalThemeEnum.Light) : theme.globalThemeMode;
			...
			set: (value) => {
				theme.primaryColor[theme.globalThemeMode === GlobalThemeEnum.System ? theme.defaultDarkMode : theme.globalThemeMode] = value;
			},
		});
